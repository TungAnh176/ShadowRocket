...
if ($request.method !== "POST") {
    $notification.post("YouTube-proto Ad-blocking Script Error", "Request method is not POST:", url);
}
...
if (url.includes("/v1/browse")) {
    ...
    $notification.post("YouTube-proto Script Matching Error", "URL:", url);
}
if (needProcessFlag) {
            ...
            item.n4F50195462.n5F1 = item.n4F50195462.n5F1.filter((el) => {
                ...
                if (el.n6F153515154?.n7F172660663?.n8F1?.n9F168777401) {
                    ...
                    const existAdStr =
                        ...
                        adStr5;
                    if (existAdStr) {
                        console.log(`Ad detected: ${existAdStr}`);
                ...
                const adStr =
                    el.n6F166487981?.n7F1?.n8F83537025?.n91F3?.n10F83784541?.n11F1?.n12F1
                        ?.s;
                if (adStr) {
                    console.log(`Ad detected 2: ${adStr}`);
                    needProcessFlag = true;
                    flag = false;
                }
                el.n6F153515154?.n7F172660663?.n8F3?.n9F3?.n10F3?.forEach?.((ell) => {
                    ell.n11F3?.forEach?.((v) => {
                        v.n12F3?.forEach?.((vv) => {
                            ...
                            if (tempStr) {
                                console.log(`Multi-image ad in the middle of the list: ${tempStr}`);
                                needProcessFlag = true;
                                flag = false;
                            }
                        });
